...
export default function Home() {
  ...
  return (
    <main className="min-h-screen bg-white text-slate-900 max-w-2xl mx-auto border-x border-slate-200 shadow-sm">
      ...
      {/* 投稿エリア（白背景で固定） */}
      <div className="fixed bottom-0 left-0 right-0 bg-white border-t border-slate-200 p-6 shadow-[0_-4px_6px_-1px_rgba(0,0,0,0.1)] max-w-2xl mx-auto z-20">
        ...
        />
        {newPost.title && (
          <div className="mt-3 p-3 bg-blue-50 border border-blue-100 rounded-lg text-sm text-blue-900 font-bold animate-pulse">
            ✅ 読込完了: {newPost.title}
          </div>
        )}
      </div>
