export default function Home() {
  ...
  const posts = [
    { id: 1, author: "久保田", title: "雨の日の放課後", body: "窓の外は灰色で、アスファルトの匂いが...", comments: 3, tag: "今週のお題" },
    { id: 2, author: "部員A", title: "無題", body: "プログラミングと文学の親和性について...", comments: 0, tag: "コラム" },
    { id: 3, author: "部員B", title: "深夜のデバッグ", body: "コンパイルが通らない。夜は更けていく...", comments: 5, tag: "創作" },
  ];
  ...
  return (
    <main className="min-h-screen bg-white max-w-2xl mx-auto border-x border-slate-200">
      ...
      <div className="divide-y divide-slate-200">
        {posts.map((post) => (
          <article key={post.id} className="p-4 hover:bg-slate-50 transition cursor-pointer">
